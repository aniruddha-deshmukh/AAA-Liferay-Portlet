...
<liferay-ui:icon-menu>
	...
	<%-- Permission Button --%>
		...
		<liferay-security:permissionsURL modelResource="<%=Customer.class.getName()%>" modelResourceDescription="<%=customer.getAddress()%>" resourcePrimKey="<%=String.valueOf(customer.getCustomerId())%>" var="permissionURL">
